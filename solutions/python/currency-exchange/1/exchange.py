...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    """Calculate the maximum value of new currency after exchange.
        Parameters:
    ...
    Note:
        The currency denomination is a whole number and cannot be sub-divided.w currency afterdetermining the exchange rate plus the spread.
    """

    pass
    return int(get_number_of_bills(exchange_money(budget, exchange_rate * (1 + spread / 100)), denomination) * denomination)
