...
def higher_card(card_one, card_two):
    ...
    pass
    return card_one if value_of_card(card_one) > value_of_card(card_two) else card_two if value_of_card(card_two) > value_of_card(card_one) else (card_one, card_two)
...
def is_blackjack(card_one, card_two):
    ...
    pass
    return (value_of_card(card_one) + value_of_card(card_two) == 21) and ('A' in [card_one, card_two]) and (value_of_card(card_one) == 10 or value_of_card(card_two) == 10)
